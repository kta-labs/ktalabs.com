(function () {
  const FAQ = [
    ...
    },
    {
      ...
      answer: "Oui, tous nos produits sont testés en laboratoire indépendant (Janoshik) avec une pureté supérieure à 99%. Les certificats sont consultables directement depuis la fiche de chaque produit via le bouton \"Test de pureté\"."
    },
    {
      id: 'parrainage',
